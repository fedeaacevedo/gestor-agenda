...
def consultar():
    ...
    lista.sort()
    valores=[]
    r.insert(INSERT, "Nombre\tApellidos P\t\tApellido M\t\tTelefono\t\tCorreo\n")
    for elemento in lista:
        arreglo= elemento.split("$")
...
cargar()
consultar()
ventana.title("ZR Estudio Contable")
ventana.geometry("700x500")
ventana.configure(background=colorFondo)
etiquetaTitulo= Label(ventana, text="Gestor de clientes", bg=colorFondo, fg=colorLetra).place(x=270,y=10)
